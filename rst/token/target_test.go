...
func Test_01_00_00_04_LexReferenceHyperlinkTargetGood(t *testing.T) {
	...
	testPath := testutil.TestPathFromName("01.00.00.04-internal-target-beginning-with-underscore")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.ExpectItems(), items)
}
...
func Test_01_00_01_01_LexReferenceHyperlinkTargetGood(t *testing.T) {
	testPath := testutil.TestPathFromName("01.00.01.01-external-target")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.ExpectItems(), items)
}

func Test_01_00_01_02_LexReferenceHyperlinkTargetGood(t *testing.T) {
...
func Test_01_00_02_00_LexReferenceHyperlinkTargetGood(t *testing.T) {
...
func Test_01_00_02_01_LexReferenceHyperlinkTargetGood(t *testing.T) {
	testPath := testutil.TestPathFromName("01.00.02.01-indirect-hyperlink-targets-phrase-references")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.ExpectItems(), items)
}
...
func Test_01_00_03_02_LexReferenceHyperlinkTargetGood(t *testing.T) {
	testPath := testutil.TestPathFromName("01.00.03.02-anonymous-external-target")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.ExpectItems(), items)
}
...
func Test_01_00_04_02_LexReferenceHyperlinkTargetGood(t *testing.T) {
	testPath := testutil.TestPathFromName("01.00.04.02-anonymous-indirect-target-multiline")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.ExpectItems(), items)
}
...
func Test_01_00_00_03_LexReferenceHyperlinkTargetBad_NotImplemented(t *testing.T) {
	...
	testPath := testutil.TestPathFromName("01.00.00.03-bad-target-missing-backquote")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.ExpectItems(), items)
}
