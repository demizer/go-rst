...
func Test_04_00_04_00_ParseSectionTitleBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.00.04.00-unexpected-titles")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_00_05_00_ParseSectionTitleBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.00.05.00-short-underline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_00_06_00_ParseSectionTitleBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.00.06.00-short-title-short-underline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_00_06_01_ParseSectionTitleBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.00.06.01-short-title-short-overline-and-underline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_00_06_02_ParseSectionTitleBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.00.06.02-short-title-short-overline-missing-underline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_00_00_ParseSectionLevelGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.00.00-section-level-return")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_00_01_ParseSectionLevelGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.00.01-section-level-return")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_00_02_ParseSectionLevelGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.00.02-section-level-return")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_01_00_ParseSectionLevelGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.01.00-section-level-return")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_02_00_ParseSectionLevelGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.02.00-two-level-one-overline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_03_00_ParseSectionLevelBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.03.00-subsection-order")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_03_01_ParseSectionLevelBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.03.01-subsection-order-with-overlines")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_01_04_00_ParseSectionLevelBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.01.04.00-two-level-overline-bad-return")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_00_00_ParseSectionTitleWithOverlineGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.00.00-title-overline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_01_00_ParseSectionTitleWithOverlineGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.01.00-inset-title-with-overline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_02_00_ParseSectionTitleWithOverlineGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.02.00-three-char-section-title")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_03_00_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.03.00-inset-title-missing-underline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_03_01_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.03.01-inset-title-missing-underline-with-blankline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_03_02_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.03.02-inset-title-missing-underline-and-paragraph")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_03_03_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.03.03-inset-title-mismatched-underline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_04_00_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.04.00-title-too-long")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_05_00_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.05.00-missing-titles-with-blankline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_05_01_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.05.01-missing-titles-with-noblankline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_06_00_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.06.00-incomplete-section")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_06_01_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.06.01-incomplete-sections-no-title")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_07_00_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.07.00-indented-title-short-overline-and-underline")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_02_08_00_ParseSectionTitleWithOverlineBad(t *testing.T) {
	testPath := testutil.TestPathFromName("04.02.08.00-two-char-section-title")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_03_00_00_ParseSectionTitleNumberedGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.03.00.00-numbered-title")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
...
func Test_04_03_01_00_ParseSectionTitleNumberedGood(t *testing.T) {
	testPath := testutil.TestPathFromName("04.03.01.00-enum-list-with-numbered-title")
	test := LoadParserTest(t, testPath)
	pTree := parseTest(t, test)
	eNodes := test.ExpectNodes()
	checkParseNodes(t, eNodes, pTree.Nodes, testPath)
