...
func Test_06_03_00_03_LexInlineLiteralBad(t *testing.T) {
	testPath := testPathFromName("06.03.00.03-literal-unclosed")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_03_00_04_LexInlineLiteralBad(t *testing.T) {
	testPath := testPathFromName("06.03.00.04-literal-unclosed")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_03_03_02_LexInlineLiteralBad(t *testing.T) {
	testPath := testPathFromName("06.03.03.02-literal-with-tex-quotes")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
