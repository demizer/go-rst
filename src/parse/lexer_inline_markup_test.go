...
func Test_06_00_03_01_LexInlineMarkupRecognitionRulesBad(t *testing.T) {
	testPath := testPathFromName("06.00.03.01-emphasis-with-unicode-literal")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_00_03_02_LexInlineMarkupRecognitionRulesBad(t *testing.T) {
	testPath := testPathFromName("06.00.03.02-emphasis-with-unicode-literal")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_01_00_01_LexStrongBad(t *testing.T) {
	testPath := testPathFromName("06.01.00.01-strong-unclosed")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_01_00_02_LexStrongBad(t *testing.T) {
	testPath := testPathFromName("06.01.00.02-strong-unclosed")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_02_00_03_LexEmphasisBad(t *testing.T) {
	testPath := testPathFromName("06.02.00.03-emphasis-unclosed")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_02_00_04_LexEmphasisBad(t *testing.T) {
	testPath := testPathFromName("06.02.00.04-emphasis-unclosed")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_02_00_05_LexEmphasisBad(t *testing.T) {
	testPath := testPathFromName("06.02.00.05-emphasis-unclosed-surrounded-by-apostrophe")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
...
func Test_06_02_01_00_LexEmphasisGood(t *testing.T) {
	testPath := testPathFromName("06.02.01.00-emphasis-with-emphasis-apostrophe")
	test := LoadLexTest(t, testPath)
	items := lexTest(t, test)
	equal(t, test.expectItems(), items)
}
